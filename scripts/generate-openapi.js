...
const routes = [
  ...
  publicRoute('get', '/v1/learn/date-add-7', 'Learning demo: add 7 days to today'),
  publicRoute('get', '/v1/learn/date-add-30', 'Learning demo: add 30 days to today'),
  publicRoute('get', '/v1/learn/date-add-90', 'Learning demo: add 90 days to today'),
  publicRoute('get', '/v1/learn/next-saturday-business-day', 'Learning demo: check whether next Saturday is a business day'),
  publicRoute('get', '/v1/learn/random-id', 'Learning demo: generate a random UUID'),
